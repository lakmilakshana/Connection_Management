...
<body onload = "JavaScript:AutoRefresh(5000);">
	...
	<div class="container">
		...
		<div class="row">
			...
			<h1>Connection Management</h1><br>

			<form id="formItem" name="formItem">
		
				<!-- CONNECTION NAME -->
				<div class="form-floating mb-3">
					<input id="connectionName" name="connectionName" type="text" class="form-control"><br>
					<label for="floatingInput">Connection Name:</label>
				</div>
